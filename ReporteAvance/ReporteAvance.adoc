...
image::images/FriendSevice/SAA.png[Evidencia funcionamiento 1 , width=600]
image::images/FriendSevice/SAEA.png[Evidencia funcionamiento 2, width=600]
image::images/FriendSevice/SAL.png[Evidencia funcionamiento 3 width=600]
image::images/FriendSevice/SAR.png[Evidencia funcionamiento 4, width=600]
...
**Cuando `block == true`:**
- Verifica si el bloqueo ya existe.
- Elimina cualquier amistad previa entre ambos usuarios.
- Elimina solicitudes de amistad enviadas entre ellos.
- Crea un nuevo registro en la tabla `bloqueos`.

**Cuando `block == false`:**
- Verifica que exista un bloqueo activo.
...
Al recibir el código ingresado, el servidor realiza tres validaciones:
1. **Existencia:** confirma que haya un código generado para ese correo.
2. **Exactitud:** verifica que el código ingresado coincida con el enviado.
3. **Validez temporal:** comprueba que no hayan pasado más de 5 minutos desde su creación.

Si cualquiera de estas condiciones falla, el servidor rechaza el registro por motivos de seguridad.  
Si todo es correcto, el código se elimina y el usuario queda autorizado para completar su creación de cuenta.
...
image::images/CodigoVerificacion/RVC.png[videncia funcionamiento 1 , width=600]
image::images/CodigoVerificacion/RVC2.png[encia funcionamiento 2, width=600]
image::images/CodigoVerificacion/RVC3.png[videncia funcionamiento 3 width=600]
image::images/CodigoVerificacion/RVT.jpg[idencia funcionamiento 4, width=600]
...
Cabe mencionar que se trabajo en la implementacion de estas funcionalidades en el cliente siguiendo la base dejada por mi compañero.
